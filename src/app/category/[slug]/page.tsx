    ...
    <div>
      ...
      <div className="bg-red-50 p-4">
        <div className="container mx-auto">
          <h1 className="text-2xl md:text-3xl font-bold text-center text-red-600 mb-2">{category.title} - UP TO 75% OFF 🔥</h1>
          <p className="text-center text-red-500 text-small md:text-base animate-pulse">⚡ Flash Sales Ending Soon! ⏱️ Limited Time Only</p>
